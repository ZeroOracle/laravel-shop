...
class CouponCodesController extends Controller
{
    ...
    {
        return (new \Encore\Admin\Admin)->content(function (Content $content) {
    ...
    {
        return (new \Encore\Admin\Admin)->content(function (Content $content) use ($id) {
    ...
    {
        return (new \Encore\Admin\Admin)->grid(CouponCode::class, function (Grid $grid) {
    ...
    {
        return (new \Encore\Admin\Admin)->form(CouponCode::class, function (Form $form) {
            $form->display('id', 'ID');
